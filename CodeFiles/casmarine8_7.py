...
"}")
        ...
        self.autoLight.setGeometry(QtCore.QRect(10, 10, 1450, 20))
        self.autoLight.setText("")
        self.autoLight.setPixmap(QtGui.QPixmap("../Static Images/AutoOffline.jpg"))
...
"color: rgb(255, 255, 255);")
        ...
        self.cameraOneCheck.setGeometry(QtCore.QRect(10, 590, 171, 21))
        font = QtGui.QFont()
        font.setFamily("8-bit Operator+ 8")
        ...
        self.cameraTwoCheck.setGeometry(QtCore.QRect(740, 590, 160, 20))
        font = QtGui.QFont()
        font.setWeight(40)
        font.setFamily("8-bit Operator+ 8")
        ...
        self.pushButton_screenshot.setGeometry(QtCore.QRect(560, 660, 131, 71))
        font = QtGui.QFont()
        font.setFamily("8-bit Operator+ 8")
        font.setPointSize(-1)
        font.setBold(False)
...
"}")
        ...
        self.label_4.setGeometry(QtCore.QRect(570, 670, 131, 71))
