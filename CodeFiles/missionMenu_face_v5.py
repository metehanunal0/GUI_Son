...
"}")
        ...
        self.label.setStyleSheet("#missionMenu{\n"
"border-image: url(D:/GUISonDegilv5/HighLevel-MMD-Station/background/undersea.jpg);\n"
"}")
        self.label.setText("")
    ...
    def retranslateUi(self, missionMenu):
        ...
        missionMenu.setWindowTitle(_translate("missionMenu", "Mission Menu"))
