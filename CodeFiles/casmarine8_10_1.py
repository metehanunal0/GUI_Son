...
"}")
        ...
        self.camOne.setText("")
        self.camOne.setPixmap(QtGui.QPixmap(":/icon2/Static Images/on.png"))
        ...
        self.camTwo.setText("")
        self.camTwo.setPixmap(QtGui.QPixmap(":/icon2/Static Images/alt.png"))
        ...
        self.autoLight.setPixmap(QtGui.QPixmap(":/icon2/Static Images/autoOff.png"))
...
"}")
        ...
        self.anim = QPropertyAnimation(self.stopwatchStart, b"pos")
...
"}")
        ...
        self.startLabel.setGeometry(
            QtCore.QRect(0, 180, 121, 61))
...
"}")
        ...
        geo = self.stopwatchStart.geometry()
        print(geo.getRect())
        def bas():
            self.anim.setEndValue(QPoint(geo.getRect()[0], geo.getRect()[1] + 5))
...
"")
        ...
        self.PIDLabel.setGeometry(QtCore.QRect(760, 650, 510, 135))
...
"}")
        ...
        self.missionLabel.setGeometry(QtCore.QRect(30, 650, 510, 135))
...
"}")
        ...
        self.ssLabel.setGeometry(QtCore.QRect(580, 670, 131, 71))
