...
class Ui_missionMenu(object):
    def setupUi(self, missionMenu):
        ...
        self.comboBox.setGeometry(QtCore.QRect(90, 20, 271, 61))
        font = QtGui.QFont()
...
"")
        ...
        self.applyLabel.setGeometry(QtCore.QRect(30, 130, 121, 51))
...
"}")
        ...
        self.applyButton.setGeometry(QtCore.QRect(20, 120, 121, 51))
        font = QtGui.QFont()
...
"}")
        ...
        self.stopButton.setGeometry(QtCore.QRect(290, 120, 121, 51))
        font = QtGui.QFont()
        font.setFamily("8-bit Operator+ 8")
        # font.setPointSize(-1)
        font.setBold(False)
...
"}")
        ...
        self.stopLabel.setGeometry(QtCore.QRect(300, 130, 121, 51))
...
"border-image: url(../Static Images/casmarine_siyah.jpeg)\n"
"")
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/icons/Static Images/casmarine_siyah.jpeg"))
