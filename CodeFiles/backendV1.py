...
class CASMarine8(QtWidgets.QMainWindow, casmarine10_1.Ui_MainWindow):
    ...
    def update_imageTwo(self, image):
        """Updates the image_label with a new opencv image"""
        print("updateimgtwogiris")
        qtImage = self.convert_cv_qt(image, 720, 540)
        self.camTwo.setPixmap(qtImage)
        print("updateimgtwocikis")

    def cameraTwoState(self):
        print("cameratwogiris")
